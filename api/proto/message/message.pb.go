...
func (ReceiverType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{0}
}
...
func (ServiceType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{1}
}
...
func (MessageType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{2}
}
...
func (LotteryRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{3, 0}
}
...
func _Message_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Message_Staking:
		b.EncodeVarint(5<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Staking); err != nil {
			return err
		}
	case *Message_Consensus:
		b.EncodeVarint(6<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Consensus); err != nil {
			return err
		}
	case *Message_Drand:
		b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Drand); err != nil {
			return err
		}
	case *Message_LotteryRequest:
		b.EncodeVarint(8<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LotteryRequest); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("Message.Request has unexpected type %T", x)
	}
	return nil
}
...
func _Message_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Message)
	switch tag {
	case 5: // request.staking
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(StakingRequest)
		err := b.DecodeMessage(msg)
		m.Request = &Message_Staking{msg}
		return true, err
	case 6: // request.consensus
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(ConsensusRequest)
		err := b.DecodeMessage(msg)
		m.Request = &Message_Consensus{msg}
		return true, err
	case 7: // request.drand
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(DrandRequest)
		err := b.DecodeMessage(msg)
		m.Request = &Message_Drand{msg}
		return true, err
	case 8: // request.lottery_request
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LotteryRequest)
		err := b.DecodeMessage(msg)
		m.Request = &Message_LotteryRequest{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Message_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.Request.(type) {
	case *Message_Staking:
		s := proto.Size(x.Staking)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Message_Consensus:
		s := proto.Size(x.Consensus)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Message_Drand:
		s := proto.Size(x.Drand)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *Message_LotteryRequest:
		s := proto.Size(x.LotteryRequest)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func _Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Response_LotteryResponse:
		b.EncodeVarint(4<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.LotteryResponse); err != nil {
			return err
		}
	case nil:
	default:
...
func _Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*Response)
	switch tag {
	case 4: // response.lottery_response
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(LotteryResponse)
		err := b.DecodeMessage(msg)
		m.Response = &Response_LotteryResponse{msg}
		return true, err
	default:
		return false, nil
	}
...
func _Response_OneofSizer(msg proto.Message) (n int) {
	...
	switch x := m.Response.(type) {
	case *Response_LotteryResponse:
		s := proto.Size(x.LotteryResponse)
		n += 1 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (dst *LotteryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LotteryResponse.Merge(dst, src)
}
...
func (*LotteryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{3}
}
...
func (dst *LotteryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_LotteryRequest.Merge(dst, src)
}
...
func (*StakingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{4}
}
...
func (dst *StakingRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_StakingRequest.Merge(dst, src)
}
...
func (*ConsensusRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{5}
}
...
func (*DrandRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_72c210ab345e5598, []int{6}
}
...
func (dst *DrandRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DrandRequest.Merge(dst, src)
}
...
func init() { proto.RegisterFile("message.proto", fileDescriptor_message_72c210ab345e5598) }

var fileDescriptor_message_72c210ab345e5598 = []byte{
