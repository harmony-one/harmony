...
func (s *Service) StartService() {
	utils.GetLogger().Info("[consensus/service] Starting consensus service.")
...
func (s *Service) StopService() {
	utils.GetLogger().Info("Stopping consensus service.")
	s.stopChan <- struct{}{}
	<-s.stoppedChan
	utils.GetLogger().Info("Consensus service stopped.")
}
