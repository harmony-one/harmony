...
// Simple test for IncorrectResponse
func TestCompareSyncPeerConfig(t *testing.T) {
	client := &downloader.Client{}
	...
	assert.Equal(t, syncPeerConfig1.Compare(syncPeerConfig2), -1, "syncPeerConfig1 is less than syncPeerConfig2")

	// syncPeerConfig1 is greater than syncPeerConfig2
	blockHashes1[0][2] = 5
	assert.Equal(t, syncPeerConfig1.Compare(syncPeerConfig2), 1, "syncPeerConfig1 is greater than syncPeerConfig2")

	// syncPeerConfig1 is equal to syncPeerConfig2
	blockHashes1[0][2] = 4
	assert.Equal(t, syncPeerConfig1.Compare(syncPeerConfig2), 0, "syncPeerConfig1 is equal to syncPeerConfig2")

	// syncPeerConfig1 is less than syncPeerConfig2
	blockHashes1 = blockHashes1[:1]
	assert.Equal(t, syncPeerConfig1.Compare(syncPeerConfig2), 0, "syncPeerConfig1 is less than syncPeerConfig2")
}
