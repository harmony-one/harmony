...
func nodeconfigSetShardSchedule(config harmonyconfig.HarmonyConfig) {
	...
	case nodeconfig.Devnet:
		...
		devnetConfig, err := shardingconfig.NewInstance(
			uint32(dnConfig.NumShards), dnConfig.ShardSize, dnConfig.HmyNodeSize, dnConfig.SlotsLimit, numeric.OneDec(), genesis.HarmonyAccounts, genesis.FoundationalNodeAccounts, shardingconfig.Allowlist{}, nil, shardingconfig.VLBPE, nil)
		if err != nil {
