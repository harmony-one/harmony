...
func (bc *BlockChainWithoutLocks) CommitOffChainData(
...
func (bc *BlockChainWithoutLocks) writeValidatorStats(
	tempValidatorStats map[common.Address]*staking.ValidatorStats,
	batch rawdb.DatabaseWriter,
) {
	type t struct {
...
func (bc *BlockChainWithoutLocks) getNextBlockEpoch(header *block.Header) (*big.Int, error) {
