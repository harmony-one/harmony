...
func (evm *EVM) Call(caller ContractRef, addr common.Address, input []byte, gas uint64, value *big.Int, txType types.TransactionType) (ret []byte, leftOverGas uint64, err error) {
