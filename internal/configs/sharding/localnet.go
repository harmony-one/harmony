...
var (
	...
	localnetV3   = MustNewInstance(2, 9, 6, numeric.MustNewDecFromStr("0.99"), genesis.LocalHarmonyAccountsV2, genesis.LocalFnAccountsV2, localnetReshardingEpoch, LocalnetSchedule.BlocksPerEpoch())
	localnetV3_1 = MustNewInstance(2, 9, 6, numeric.MustNewDecFromStr("0.99"), genesis.LocalHarmonyAccountsV2, genesis.LocalFnAccountsV2, localnetReshardingEpoch, LocalnetSchedule.BlocksPerEpoch())
)
