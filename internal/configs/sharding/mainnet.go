...
var (
	...
	mainnetV3_3 = MustNewInstance(4, 250, 25, numeric.MustNewDecFromStr("0.85"), genesis.HarmonyAccounts, genesis.FoundationalNodeAccountsV1_5, mainnetReshardingEpoch, MainnetSchedule.BlocksPerEpoch())
)
