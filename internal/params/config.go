...
var (
	...
	AllProtocolChanges = &ChainConfig{
		...
		big.NewInt(0),                      //ReimbursementEpoch
	}
...
type ChainConfig struct {
	...
	// ReimbursementEpoch is the first epoch to Reimburse
	ReimbursementEpoch *big.Int
}
...
// IsReimbursementEpoch determines whether Reimbursement is actived
func (c *ChainConfig) IsReimbursementEpoch(epoch *big.Int) bool {
	return isForked(c.ReimbursementEpoch, epoch)
}
