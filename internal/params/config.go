...
type ChainConfig struct {
	...
	// StakingV2Epoch is the epoch when Staking V2 is activated, including batch
	// staking directives, redelegation fixes, and write-capable precompile revert
	// behavior with ABI-encoded failure reasons.
...
// IsStakingV2 determines whether Staking V2 rules are active at the given epoch.
