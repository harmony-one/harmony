...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		TimestampValidationEpoch:              big.NewInt(2950),
		IsOneSecondEpoch:                      EpochTBD,
		EIP2537PrecompileEpoch:                EpochTBD,
		EIP1153TransientStorageEpoch:          big.NewInt(2950),
		EIP7939CLZEpoch:                       big.NewInt(2950),
		EIP5656McopyEpoch:                     big.NewInt(2950),
		EIP3855Epoch:                          big.NewInt(2950),
		EIP3860Epoch:                          big.NewInt(2950),
		EIP6780Epoch:                          big.NewInt(2950),
		PragueEpoch:                           EpochTBD,
		EIP8024Epoch:                          big.NewInt(2950),
	}
