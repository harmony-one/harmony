...
const (
	...
	// InitCodeWordGas is the gas cost per 32-byte chunk of initcode (EIP-3860)
	InitCodeWordGas uint64 = 2 // Gas cost per 32-byte chunk of initcode
