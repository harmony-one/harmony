...
// CreateBuildConfigWithDatastore ..
func CreateBuildConfigWithDatastore(
	opts *BuildOpts, ds ipfs_datastore.Batching,
) (*ipfs_node.BuildCfg, error) {
	if opts == nil {
		opts = &BuildOpts{}
	}
...
// CreateRepo ..
func CreateRepo(
	dstore ipfs_datastore.Batching, opts *BuildOpts,
) (ipfs_repo.Repo, error) {
	c := ipfs_cfg.Config{}
	priv, pub, err := libp2p_ci.GenerateKeyPairWithReader(
		libp2p_ci.RSA, 2048, crand.Reader,
	) // nolint:staticcheck
	if err != nil {
		return nil, err
	}
