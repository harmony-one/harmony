...
func fundFaucetContract(chain *core.BlockChain) {
	...
	txs = append(txs, tx)
	err := contractworker.CommitTransactions(txs, staking.Transactions{}, testUserAddress)
	if err != nil {
		fmt.Println(err)
	}
...
func callFaucetContractToFundAnAddress(chain *core.BlockChain) {
	...
	err = contractworker.CommitTransactions(types.Transactions{callfaucettx}, staking.Transactions{}, testUserAddress)
	if err != nil {
		fmt.Println(err)
	}
	if err != nil {
...
func playStaking(chain *core.BlockChain) {
	...
	err = contractworker.CommitTransactions(stakingtxns, staking.Transactions{}, common.Address{})
...
func playWithdrawStaking(chain *core.BlockChain) {
	...
	err = contractworker.CommitTransactions(withdrawstakingtxns, staking.Transactions{}, common.Address{})
	if err != nil {
		fmt.Println("error:")
		fmt.Println(err)
	}
